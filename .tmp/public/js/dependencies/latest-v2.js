!function (e) {
    ...
    return function (e, t, n) {
        ...
        1: [function (e, t) {
            function n(e) {
                var t, n, u = this, p = e || {}, d = this.config = {
            ...
            var r = e("./webrtc"), o = e("wildemitter"), i = e("webrtcsupport"), a = e("attachmediastream"), s = e("mockconsole"), c = e("./socketioconnection");
            n.prototype = Object.create(o.prototype, {constructor: {value: n}}), n.prototype.leaveRoom = function () {
                if (this.roomName) {
                ...
                var t = this, n = this.getRemoteVideoContainer(), r = a(e.stream);
                ...
                this.roomName = e, this.connection.emit("join", e, function (r, o) {
                    if (console.log("join CB", r, o), r)n.emit("error", r); else {
                        var i, a, s, c;
                        for (i in o.clients) {
                            a = o.clients[i];
        ...
        4: [function (e, t) {
            ...
            t.exports = n, n.mixin = function (e) {
                ...
                t.isWildEmitter = !0, t.on = function (e) {
                    ...
                    var t = 3 === arguments.length, n = t ? arguments[1] : void 0, r = t ? arguments[2] : arguments[1];
                    ...
                    var n = this, r = 3 === arguments.length, o = r ? arguments[1] : void 0, i = r ? arguments[2] : arguments[1];
                    return this.on(e, o, t), this
                }, t.releaseGroup = function (e) {
                    this.callbacks = this.callbacks || {};
                    var t, n, r, o;
                    for (t in this.callbacks)for (o = this.callbacks[t], n = 0, r = o.length; r > n; n++)o[n]._groupName === e && (o.splice(n, 1), n--, r--);
                    return this
                }, t.off = function (e, t) {
                    this.callbacks = this.callbacks || {};
                    ...
                    this.callbacks = this.callbacks || {};
                    var t, n, r, o = [].slice.call(arguments, 1), i = this.callbacks[e], a = this.getWildcardCallbacks(e);
                    if (i)for (r = i.slice(), t = 0, n = r.length; n > t && r[t]; ++t)r[t].apply(this, o);
                    if (a)for (n = a.length, r = a.slice(), t = 0, n = r.length; n > t && r[t]; ++t)r[t].apply(this, [e].concat(o));
                    return this
        ...
        6: [function (e, t) {
            for (var n = "assert,count,debug,dir,dirxml,error,exception,group,groupCollapsed,groupEnd,info,log,markTimeline,profile,profileEnd,time,timeEnd,trace,warn".split(","), r = n.length, o = function () {
            }, i = {}; r--;)i[n[r]] = o;
            t.exports = i
        }, {}],
        7: [function (e, t) {
        ...
        3: [function (e, t) {
            ...
            var r = e("util"), o = e("webrtcsupport");
            e("wildemitter");
            var i = e("mockconsole"), a = e("localmedia"), s = e("./peer");
        ...
        }, {"./peer": 9, localmedia: 10, mockconsole: 6, util: 8, webrtcsupport: 7, wildemitter: 4}],
        2: [function (e, t) {
            function n(e) {
        ...
        5: [function (e, t) {
            ...
            t.exports = function (e, t, r) {
                var o;
                window.URL;
                var i = t, a = {autoplay: !0, mirror: !1, muted: !1, audio: !1, disableContextMenu: !1};
                if (r)for (o in r)a[o] = r[o];
        ...
        12: [function (e, t, n) {
            ...
            var i = n.EventEmitter = o.EventEmitter, a = "function" == typeof Array.isArray ? Array.isArray : function (e) {
        ...
        13: [function (t, n) {
            ...
            var o = null, i = null, a = null, s = null, c = null, u = null, p = {
                log: function () {
            ...
            if ("object" == typeof window && (!window.HTMLMediaElement || "srcObject"in window.HTMLMediaElement.prototype || Object.defineProperty(window.HTMLMediaElement.prototype, "srcObject", {
                ...
                if (p.log("This appears to be Firefox"), s = "firefox", c = p.extractVersion(navigator.userAgent, /Firefox\/([0-9]+)\./, 1), u = 31, window.RTCPeerConnection = function (e, t) {
                        if (38 > c && e && e.iceServers) {
                            for (var n = [], r = 0; r < e.iceServers.length; r++) {
                                ...
                                if (o.hasOwnProperty("urls"))for (var i = 0; i < o.urls.length; i++) {
                                    var a = {url: o.urls[i]};
                ...
                p.log("This appears to be Chrome"), s = "chrome", c = p.extractVersion(navigator.userAgent, /Chrom(e|ium)\/([0-9]+)\./, 2), u = 38, window.RTCPeerConnection = function (e, t) {
                    ...
                    var n = new webkitRTCPeerConnection(e, t), r = n.getStats.bind(n);
            ...
            } else navigator.mediaDevices && navigator.userAgent.match(/Edge\/(\d+).(\d+)$/) ? (p.log("This appears to be Edge"), s = "edge", c = p.extractVersion(navigator.userAgent, /Edge\/(\d+).(\d+)$/, 2), u = 12) : p.log("Browser does not appear to be WebRTC-capable"); else p.log("This does not appear to be a browser"), s = "not a browser";
            var h = {};
            try {
        ...
        9: [function (e, t) {
            function n(e) {
                ...
                a.call(this), this.id = e.id, this.parent = e.parent, this.type = e.type || "video", this.oneway = e.oneway || !1, this.sharemyscreen = e.sharemyscreen || !1, this.browserPrefix = e.prefix, this.stream = e.stream, this.enableDataChannels = void 0 === e.enableDataChannels ? this.parent.config.enableDataChannels : e.enableDataChannels, this.receiveMedia = e.receiveMedia || this.parent.config.receiveMedia, this.channels = {}, this.sid = e.sid || Date.now().toString(), this.pc = new i(this.parent.config.peerConnectionConfig, this.parent.config.peerConnectionConstraints), this.pc.on("ice", this.onIceCandidate.bind(this)), this.pc.on("endOfCandidates", function (e) {
                    ...
                    e.protocol === c && (e.onmessage = function (n) {
                        var r = JSON.parse(n.data), o = new s.Receiver;
            ...
            var r = e("util"), o = e("webrtcsupport"), i = e("rtcpeerconnection"), a = e("wildemitter"), s = e("filetransfer"), c = "https://simplewebrtc.com/protocol/filetransfer#inband-v1";
        ...
        }, {filetransfer: 15, rtcpeerconnection: 16, util: 8, webrtcsupport: 7, wildemitter: 4}],
        11: [function (e, t) {
            t.exports = e("./lib/")
        }, {"./lib/": 17}],
        18: [function (e, t) {
        ...
        10: [function (e, t) {
            ...
            var r = e("util"), o = e("hark"), i = e("webrtcsupport"), a = e("getusermedia"), s = e("getscreenmedia"), c = e("wildemitter"), u = e("mediastream-gain"), p = e("mockconsole");
            r.inherits(n, c), n.prototype.start = function (e, t) {
                ...
                a(r, function (e, o) {
                    ...
                    } else r.audio && n.config.detectSpeakingEvents && n.setupAudioMonitor(o, n.config.harkOptions), n.localStreams.push(o), n.config.autoAdjustMic && (n.gainController = new u(o), n.setMicIfEnabled(.5)), o.onended = function () {
        ...
        16: [function (e, t) {
            ...
            var r = e("util"), o = e("lodash.foreach"), i = e("lodash.pluck"), a = e("sdp-jingle-json"), s = e("wildemitter"), c = e("traceablepeerconnection"), u = e("webrtc-adapter-test");
            r.inherits(n, s), Object.defineProperty(n.prototype, "signalingState", {
                ...
                if (e.contents || e.jingle && e.jingle.contents) {
                    var r = i(this.remoteDescription.contents, "name"), o = e.contents || e.jingle.contents;
                    o.forEach(function (e) {
                        var t = e.transport || {}, o = t.candidates || [], i = r.indexOf(e.name), s = e.name;
                        o.forEach(function (e) {
                ...
                if (e.type = "offer", e.jingle) {
                    if (this.enableChromeNativeSimulcast && e.jingle.contents.forEach(function (e) {
                        ...
                        var r = e.jingle.contents[1], o = r.description && r.description.bandwidth;
                ...
                var n = 2 === arguments.length, r = n ? t : e, o = n && e ? e : {
                    mandatory: {
                        OfferToReceiveAudio: !0,
                        OfferToReceiveVideo: !0
                    }
                ...
                return "closed" === this.pc.signalingState ? t("Already closed") : (n.pc.createAnswer(function (e) {
                    ...
                    if (n.enableChromeNativeSimulcast && (e.jingle = a.toSessionJSON(e.sdp, {
                        ...
                        var o = e.jingle.contents[1].description.sourceGroups || [], i = !1;
                    ...
                    n.assumeSetLocalSuccess && (n.emit("answer", u), t(null, u)), n._candidateBuffer = [], n.pc.setLocalDescription(e, function () {
                        if (n.config.useJingle) {
                            var r = a.toSessionJSON(e.sdp, {role: n._role(), direction: "outgoing"});
        ...
        19: [function (e, t) {
            ...
            var r = e("wildemitter"), o = window.AudioContext || window.webkitAudioContext, i = null;
            t.exports = function (e, t) {
                var a = new r;
                if (!o)return a;
                var t = t || {}, s = t.smoothing || .1, c = t.interval || 50, u = t.threshold, p = t.play, d = t.history || 10, f = !0;
                i || (i = new o);
                var l, h, g;
        ...
        20: [function (e, t) {
            e("webrtc-adapter-test"), t.exports = function (e, t) {
                var n, r = 2 === arguments.length, o = {
                    video: !0,
                    audio: !0
                }, i = "PermissionDeniedError", a = "PERMISSION_DENIED", s = "ConstraintNotSatisfiedError";
        ...
        24: [function (e, t, n) {
            var r = e("./lib/tosdp"), o = e("./lib/tojson");
        ...
        }, {"./lib/tojson": 31, "./lib/tosdp": 30}],
        21: [function (e, t) {
            var n = e("getusermedia"), r = {};
            t.exports = function (e, t) {
                var o, i = 2 === arguments.length, a = i ? t : e;
                ...
                if (window.navigator.userAgent.match("Chrome")) {
                    ...
                    if (window.navigator.userAgent.match("Linux") && (c = 35), sessionStorage.getScreenMediaJSExtensionId)chrome.runtime.sendMessage(sessionStorage.getScreenMediaJSExtensionId, {
                        ...
                        if (t && "" !== t.sourceId)e = i && e || {
                            ...
                            }, e.video.mandatory.chromeMediaSourceId = t.sourceId, n(e, a); else {
                        ...
                        r[p] = [a, i ? e : null], window.postMessage({type: "getScreen", id: p}, "*")
                    }
                ...
                if (e.origin == window.location.origin)if ("gotScreen" == e.data.type && r[e.data.id]) {
                    var t = r[e.data.id], o = t[1], i = t[0];
        ...
        17: [function (e, t, n) {
            ...
            var o = e("./url"), i = e("socket.io-parser"), a = e("./manager"), s = e("debug")("socket.io-client");
            t.exports = n = r;
            var c = n.managers = {};
            n.protocol = i.protocol, n.connect = r, n.Manager = e("./manager"), n.Socket = e("./socket")
        }, {"./manager": 33, "./socket": 34, "./url": 32, debug: 35, "socket.io-parser": 36}],
        37: [function (e, t) {
            function n(e, t, n) {
                return e.on(t, n), {
                    destroy: function () {
        ...
        35: [function (e, t) {
            ...
            t.exports = n, n.names = [], n.skips = [], n.enable = function (e) {
                ...
                for (var t = 0, r = n.skips.length; r > t; t++)if (n.skips[t].test(e))return !1;
                for (var t = 0, r = n.names.length; r > t; t++)if (n.names[t].test(e))return !0;
                return !1
            };
            try {
        ...
        26: [function (e, t) {
            ...
            var r = e("lodash._arrayeach"), o = e("lodash._baseeach"), i = e("lodash._bindcallback"), a = e("lodash.isarray"), s = n(r, o);
            t.exports = s
        }, {"lodash._arrayeach": 38, "lodash._baseeach": 39, "lodash._bindcallback": 40, "lodash.isarray": 41}],
        27: [function (e, t) {
            function n(e) {
                return function (t) {
            ...
            var u = e("lodash._baseget"), p = e("lodash._topath"), d = e("lodash.isarray"), f = e("lodash.map"), l = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\n\\]|\\.)*?\1)\]/, h = /^\w*$/;
            t.exports = a
        }, {"lodash._baseget": 42, "lodash._topath": 43, "lodash.isarray": 44, "lodash.map": 45}],
        30: [function (e, t, n) {
            var r = e("./senders");
            n.toSessionSDP = function (e, t) {
                t.role || "initiator", t.direction || "outgoing";
                var r = t.sid || e.sid || Date.now(), o = t.time || Date.now(), i = ["v=0", "o=- " + r + " " + o + " IN IP4 0.0.0.0", "s=-", "t=0 0", "a=msid-semantic: WMS *"], a = e.groups || [];
                ...
                var o = [], i = t.role || "initiator", a = t.direction || "outgoing", s = e.description, c = e.transport, u = s.payloads || [], p = c && c.fingerprints || [], d = [];
        ...
        31: [function (e, t, n) {
            var r = e("./senders"), o = e("./parsers"), i = Math.random();
            n._setIdCounter = function (e) {
                i = e
            }, n.toSessionJSON = function (e, t) {
                var r, i = t.creators || [], a = t.role || "initiator", s = t.direction || "outgoing", c = e.split("\r\nm=");
                ...
                var a = i.creator || "initiator", s = i.role || "initiator", c = i.direction || "outgoing", u = o.lines(e), p = o.lines(t), d = o.mline(u[0]), f = {
                    creator: a,
                    name: d.media,
                    description: {
                        descType: "rtp",
                ...
                var l = f.description, h = f.transport, g = o.findLine("a=mid:", u);
        ...
        41: [function (e, t) {
            ...
            var c = "[object Array]", u = "[object Function]", p = /^\[object .+?Constructor\]$/, d = Object.prototype, f = Function.prototype.toString, l = d.hasOwnProperty, h = d.toString, g = RegExp("^" + f.call(l).replace(/[\\^$.*+?()[\]{}|]/g, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"), m = r(Array, "isArray"), v = 9007199254740991, y = m || function (e) {
        ...
        32: [function (e, t) {
            ...
            var r = self, o = e("parseuri"), i = e("debug")("socket.io-client:url");
            t.exports = n
        }, {debug: 35, parseuri: 48}],
        33: [function (e, t) {
            function n(e, t) {
            ...
            e("./url");
            var r = e("engine.io-client"), o = e("./socket"), i = e("component-emitter"), a = e("socket.io-parser"), s = e("./on"), c = e("component-bind");
            e("object-component");
            var u = e("debug")("socket.io-client:manager"), p = e("indexof"), d = e("backo2");
        ...
        34: [function (e, t, n) {
            ...
            var o = e("socket.io-parser"), i = e("component-emitter"), a = e("to-array"), s = e("./on"), c = e("component-bind"), u = e("debug")("socket.io-client:socket"), p = e("has-binary");
            t.exports = n = r;
            var d = {
                connect: 1,
                connect_error: 1,
        ...
        47: [function (e, t, n) {
            n.lines = function (e) {
                ...
                for (var r = e.length, o = 0; o < t.length; o++)if (t[o].substr(0, r) === e)return t[o];
                if (!n)return !1;
                for (var i = 0; i < n.length; i++)if (n[i].substr(0, r) === e)return n[i];
                return !1
                ...
                var t = e.substr(9).split(" "), n = {}, r = t.shift(), o = r.indexOf("/");
                ...
                for (var t = [], n = {}, r = 0; r < e.length; r++) {
                    var o = e[r].substr(7).split(" "), i = o.shift();
                    if (!n[i]) {
                        var a = {ssrc: i, parameters: []};
                        t.push(a), n[i] = a
                    }
                    o = o.join(" ").split(":");
                    var s = o.shift(), c = o.join(":") || null;
                    n[i].parameters.push({key: s, value: c})
                }
                return t
            }, n.groups = function (e) {
        ...
        }, {util: 8, "webrtc-adapter-test": 23, wildemitter: 4}],
        52: [function (e, t, n) {
        ...
        36: [function (e, t, n) {
            ...
            function i(e, t) {
                function n(e) {
                    var n = l.deconstructPacket(e), r = o(n.packet), i = n.buffers;
                    i.unshift(r), t(i)
                }
            ...
            var p = e("debug")("socket.io-parser"), d = e("json3");
            e("isarray");
            var f = e("component-emitter"), l = e("./binary"), h = e("./is-buffer");
            n.protocol = 4, n.types = ["CONNECT", "DISCONNECT", "EVENT", "BINARY_EVENT", "ACK", "BINARY_ACK", "ERROR"], n.CONNECT = 0, n.DISCONNECT = 1, n.EVENT = 2, n.ACK = 3, n.ERROR = 4, n.BINARY_EVENT = 5, n.BINARY_ACK = 6, n.Encoder = r, n.Decoder = a, r.prototype.encode = function (e, t) {
                if (p("encoding packet %j", e), n.BINARY_EVENT == e.type || n.BINARY_ACK == e.type)i(e, t); else {
                    var r = o(e);
                    t([r])
                }
        ...
        }, {"./binary": 59, "./is-buffer": 57, "component-emitter": 49, debug: 35, isarray: 58, json3: 60}],
        60: [function (t, n, r) {
            !function (t) {
                function n(e) {
                    if (n[e] !== a)return n[e];
                ...
                var o, i, a, s = {}.toString, c = "function" == typeof e && e.amd, u = "object" == typeof JSON && JSON, p = "object" == typeof r && r && !r.nodeType && r;
                ...
                if (!n("json")) {
                    var l = "[object Function]", h = "[object Date]", g = "[object Number]", m = "[object String]", v = "[object Array]", y = "[object Boolean]", b = n("bug-string-char-index");
                    if (!d)var w = Math.floor, S = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334], k = function (e, t) {
                        return S[t] + 365 * (e - 1970) + w((e - 1969 + (t = +(t > 1))) / 4) - w((e - 1901 + t) / 100) + w((e - 1601 + t) / 400)
                    };
                    (o = {}.hasOwnProperty) || (o = function (e) {
                        var t, n = {};
                        return (n.__proto__ = null, n.__proto__ = {toString: 1}, n).toString != s ? o = function (e) {
                            var t = this.__proto__, n = (this.__proto__ = null, e in this);
                    ...
                    var C = {"boolean": 1, number: 1, string: 1, undefined: 1}, x = function (e, t) {
                        var n = typeof e[t];
                    ...
                    if (i = function (e, t) {
                            ...
                            return n = r = null, c ? i = 2 == c ? function (e, t) {
                                ...
                                var n, i, a = s.call(e) == l, c = !a && "function" != typeof e.constructor && x(e, "hasOwnProperty") ? e.hasOwnProperty : o;
                        ...
                        var E = {
                            ...
                            if ("object" == typeof d && d)if (f = s.call(d), f != h || o.call(d, "toJSON"))"function" == typeof d.toJSON && (f != g && f != m && f != v || o.call(d, "toJSON")) && (d = d.toJSON(e)); else if (d > -1 / 0 && 1 / 0 > d) {
                                if (k) {
                            ...
                            if (f == m)return D("" + d);
                            if ("object" == typeof d) {
                                for (_ = p.length; _--;)if (p[_] === d)throw TypeError();
                        ...
                        p.stringify = function (e, t, n) {
                            var r, o, i, a;
                            if ("function" == typeof t || "object" == typeof t && t)if ((a = s.call(t)) == l)o = t; else if (a == v) {
                                i = {};
                                for (var c, u = 0, p = t.length; p > u; c = t[u++], a = s.call(c), (a == m || a == g) && (i[c] = 1));
                            }
                            if (n)if ((a = s.call(n)) == g) {
                    ...
                    if (!n("json-parse")) {
                        var R, M, P = String.fromCharCode, _ = {
                            92: "\\",
                            34: '"',
                            47: "/",
                            98: "\b",
                            ...
                            for (var e, t, n, r, o, i = M, a = i.length; a > R;)switch (o = i.charCodeAt(R)) {
                                ...
                                case 34:
                                    for (e = "@", R++; a > R;)if (o = i.charCodeAt(R), 32 > o)I(); else if (92 == o)switch (o = i.charCodeAt(++R)) {
                                        case 92:
                                        case 34:
                                        case 47:
                                        case 98:
                            ...
                            var r, o = e[t];
                            if ("object" == typeof o && o)if (s.call(o) == v)for (r = o.length; r--;)B(o, r, n); else i(o, function (e) {
                                B(o, e, n)
                            });
                            return n.call(e, t, o)
                        };
        ...
        39: [function (e, t) {
            ...
            function o(e, t) {
                return function (n, r) {
                    var o = n ? l(n) : 0;
                    if (!a(o))return e(n, r);
                    for (var i = t ? o : -1, c = s(n); (t ? i-- : ++i < o) && r(c[i], i, c) !== !1;);
                    return n
                }
            }
            ...
            var u = e("lodash.keys"), p = 9007199254740991, d = o(n), f = i(), l = r("length");
            t.exports = d
        }, {"lodash.keys": 61}],
        50: [function (e, t) {
            t.exports = e("./lib/")
        ...
        59: [function (e, t, n) {
            var r = self, o = e("isarray"), i = e("./is-buffer");
            n.deconstructPacket = function (e) {
                ...
                var n = [], r = e.data, a = e;
                return a.data = t(r), a.attachments = n.length, {packet: a, buffers: n}
                ...
                function n(e, c, u) {
                    ...
                    } else if (o(e))for (var d = 0; d < e.length; d++)n(e[d], d, e); else if (e && "object" == typeof e && !i(e))for (var f in e)n(e[f], f, e)
                }

                var a = 0, s = e;
                n(s), a || t(s)
            }
        }, {"./is-buffer": 57, isarray: 58}],
        63: [function (e, t) {
            function n(e, t) {
        ...
        43: [function (e, t) {
            ...
            var o = e("lodash.isarray"), i = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\n\\]|\\.)*?)\2)\]/g, a = /\\(\\)?/g;
            t.exports = r
        }, {"lodash.isarray": 44}],
        45: [function (e, t) {
            function n(e, t) {
                var n = -1, r = o(e) ? Array(e.length) : [];
            ...
            var s = e("lodash._arraymap"), c = e("lodash._basecallback"), u = e("lodash._baseeach"), p = e("lodash.isarray"), d = 9007199254740991, f = r("length");
            t.exports = a
        }, {"lodash._arraymap": 63, "lodash._basecallback": 65, "lodash._baseeach": 66, "lodash.isarray": 44}],
        64: [function (e, t) {
            t.exports = Array.isArray || function (e) {
                    return "[object Array]" == Object.prototype.toString.call(e)
                }
        ...
        67: [function (e, t) {
            ...
            var s = "[object Function]", c = /^\[object .+?Constructor\]$/, u = Object.prototype, p = Function.prototype.toString, d = u.hasOwnProperty, f = u.toString, l = RegExp("^" + p.call(d).replace(/[\\^$.*+?()[\]{}|]/g, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$");
            t.exports = r
        }, {}],
        68: [function (e, t) {
            function n(e, t, n) {
        ...
        69: [function (e, t) {
            ...
            var s = Object.prototype, c = s.hasOwnProperty, u = s.propertyIsEnumerable, p = 9007199254740991, d = r("length");
            t.exports = a
        }, {}],
        66: [function (e, t) {
            function n(e, t) {
        ...
        65: [function (e, t) {
            ...
            function s(e, t) {
                var n = k(e), r = f(e) && l(t), i = e + "";
                return e = g(e), function (a) {
                    if (null == a)return !1;
                    var s = i;
                    if (a = h(a), !(!n && r || s in a)) {
            ...
            var w = e("lodash._baseisequal"), S = e("lodash._bindcallback"), k = e("lodash.isarray"), C = e("lodash.pairs"), x = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\n\\]|\\.)*?\1)\]/, E = /^\w*$/, j = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\n\\]|\\.)*?)\2)\]/g, O = /\\(\\)?/g;
            t.exports = r
        }, {"lodash._baseisequal": 73, "lodash._bindcallback": 68, "lodash.isarray": 44, "lodash.pairs": 74}],
        61: [function (e, t) {
            function n(e) {
                return function (t) {
                    return null == t ? void 0 : t[e]
            ...
            var u = e("lodash._getnative"), p = e("lodash.isarguments"), d = e("lodash.isarray"), f = /^\d+$/, l = Object.prototype, h = l.hasOwnProperty, g = u(Object, "keys"), m = 9007199254740991, v = n("length"), y = g ? function (e) {
                var t = null == e ? void 0 : e.constructor;
                return "function" == typeof t && t.prototype === e || "function" != typeof e && r(e) ? a(e) : s(e) ? g(e) : []
            } : a;
            t.exports = y
        }, {"lodash._getnative": 67, "lodash.isarguments": 69, "lodash.isarray": 41}],
        75: [function (e, t) {
            function n(e) {
                return !!e && "object" == typeof e
            }
            ...
            var i = "[object Arguments]", a = "[object Array]", s = "[object Boolean]", c = "[object Date]", u = "[object Error]", p = "[object Function]", d = "[object Map]", f = "[object Number]", l = "[object Object]", h = "[object RegExp]", g = "[object Set]", m = "[object String]", v = "[object WeakMap]", y = "[object ArrayBuffer]", b = "[object Float32Array]", w = "[object Float64Array]", S = "[object Int8Array]", k = "[object Int16Array]", C = "[object Int32Array]", x = "[object Uint8Array]", E = "[object Uint8ClampedArray]", j = "[object Uint16Array]", O = "[object Uint32Array]", T = {};
            T[b] = T[w] = T[S] = T[k] = T[C] = T[x] = T[E] = T[j] = T[O] = !0, T[i] = T[a] = T[y] = T[s] = T[c] = T[u] = T[p] = T[d] = T[f] = T[l] = T[h] = T[g] = T[m] = T[v] = !1;
            var D = Object.prototype, A = D.toString, R = 9007199254740991;
            t.exports = o
        }, {}],
        76: [function (e, t) {
        ...
        77: [function (e, t, n) {
            ...
            var o = self, i = e("xmlhttprequest"), a = e("./polling-xhr"), s = e("./polling-jsonp"), c = e("./websocket");
            n.polling = r, n.websocket = c
        }, {"./polling-jsonp": 80, "./polling-xhr": 79, "./websocket": 81, xmlhttprequest: 78}],
        82: [function (e, t) {
            var n = /^(?:(?![^:@]+:[^:@\/]*@)(http|https|ws|wss):\/\/)?((?:(([^:@]*)(?::([^:@]*))?)?@)?((?:[a-f0-9]{0,4}:){2,7}[a-f0-9]{0,4}|[^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/, r = ["source", "protocol", "authority", "userInfo", "user", "password", "host", "port", "relative", "path", "directory", "file", "query", "anchor"];
            t.exports = function (e) {
        ...
        83: [function (e, t) {
            var n = self, r = /^[\],:{}\s]*$/, o = /\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g, i = /"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g, a = /(?:^|:|,)(?:\s*\[)+/g, s = /^\s+/, c = /\s+$/;
            t.exports = function (e) {
        ...
        71: [function (e, t) {
            ...
            var o = self, i = e("./transports"), a = e("component-emitter"), s = e("debug")("engine.io-client:socket"), c = e("indexof"), u = e("engine.io-parser"), p = e("parseuri"), d = e("parsejson"), f = e("parseqs");
            t.exports = n, n.priorWebsocketSuccess = !1, a(n.prototype), n.protocol = u.protocol, n.Socket = n, n.Transport = e("./transport"), n.transports = e("./transports"), n.parser = e("engine.io-parser"), n.prototype.createTransport = function (e) {
                ...
                var e;
                if (this.rememberUpgrade && n.priorWebsocketSuccess && -1 != this.transports.indexOf("websocket"))e = "websocket"; else {
                    ...
                    d || (s('probe transport "%s" opened', e), p.send([{
                        ...
                        if (!d)if ("pong" == t.type && "probe" == t.data) {
                            ...
                            n.priorWebsocketSuccess = "websocket" == p.name, s('pausing current transport "%s"', f.transport.name), f.transport.pause(function () {
                                d || "closed" != f.readyState && (s("changing transport and sending upgrade packet"), u(), f.setTransport(p), p.send([{type: "upgrade"}]), f.emit("upgrade", p), p = null, f.upgrading = !1, f.flush())
                            })
                        } else {
                ...
                var p = this.createTransport(e, {probe: 1}), d = !1, f = this;
        ...
        73: [function (e, t) {
            ...
            function i(e, t, n, r, o, i, u) {
                var f = p(e), g = p(t), m = h, v = h;
                f || (m = x.call(e), m == l ? m = b : m != b && (f = d(e))), g || (v = x.call(t), v == l ? v = b : v != b && (g = d(t)));
                var y = m == b, w = v == b, S = m == v;
                if (S && !f && !y)return s(e, t, m);
                if (!o) {
                    var k = y && C.call(e, "__wrapped__"), E = w && C.call(t, "__wrapped__");
                    if (k || E)return n(k ? e.value() : e, E ? t.value() : t, r, o, i, u)
                }
                if (!S)return !1;
                i || (i = []), u || (u = []);
                for (var j = i.length; j--;)if (i[j] == e)return u[j] == t;
                i.push(e), u.push(t);
            ...
            function a(e, t, n, o, i, a, s) {
                var c = -1, u = e.length, p = t.length;
                if (u != p && !(i && p > u))return !1;
                for (; ++c < u;) {
                    var d = e[c], f = t[c], l = o ? o(i ? f : d, i ? d : f, c) : void 0;
                    if (void 0 !== l) {
                        if (l)continue;
                        return !1
                    }
            ...
            function c(e, t, n, r, o, i, a) {
                var s = f(e), c = s.length, u = f(t), p = u.length;
                if (c != p && !o)return !1;
                for (var d = c; d--;) {
                    var l = s[d];
                ...
                for (var h = o; ++d < c;) {
                    l = s[d];
                    var g = e[l], m = t[l], v = r ? r(o ? m : g, o ? g : m, l) : void 0;
            ...
            var p = e("lodash.isarray"), d = e("lodash.istypedarray"), f = e("lodash.keys"), l = "[object Arguments]", h = "[object Array]", g = "[object Boolean]", m = "[object Date]", v = "[object Error]", y = "[object Number]", b = "[object Object]", w = "[object RegExp]", S = "[object String]", k = Object.prototype, C = k.hasOwnProperty, x = k.toString;
            t.exports = o
        }, {"lodash.isarray": 44, "lodash.istypedarray": 75, "lodash.keys": 70}],
        90: [function (t, n, r) {
            var o = self;
            !function (t) {
                function i(e) {
                ...
                var h = "object" == typeof r && r, g = "object" == typeof n && n && n.exports == h && n, m = "object" == typeof o && o;
                (m.global === m || m.window === m) && (t = m);
                var v, y, b, w = String.fromCharCode, S = {version: "2.0.0", encode: p, decode: l};
                if ("function" == typeof e && "object" == typeof e.amd && e.amd)e(function () {
                    return S
                }); else if (h && !h.nodeType)if (g)g.exports = S; else {
                    var k = {}, C = k.hasOwnProperty;
        ...
        70: [function (e, t) {
            ...
            t.exports = y
        }, {"lodash._getnative": 87, "lodash.isarguments": 88, "lodash.isarray": 44}],
        91: [function (e, t) {
        ...
        92: [function (e, t, n) {
            !function (e) {
                ...
                n.encode = function (t) {
                    ...
                    var n, r, o, i, a, s = .75 * t.length, c = t.length, u = 0;
                    "=" === t[t.length - 1] && (s--, "=" === t[t.length - 2] && s--);
                    var p = new ArrayBuffer(s), d = new Uint8Array(p);
        ...
        94: [function (e, t) {
            ...
            var i = self, a = i.BlobBuilder || i.WebKitBlobBuilder || i.MSBlobBuilder || i.MozBlobBuilder, s = function () {
                try {
                    var e = new Blob(["hi"]);
                    return 2 === e.size
                } catch (t) {
        ...
        85: [function (e, t) {
            ...
            var r = e("engine.io-parser"), o = e("component-emitter");
        ...
        }, {"component-emitter": 49, "engine.io-parser": 72}],
        72: [function (e, t, n) {
            function r(e, t) {
            ...
            var c = self, u = e("./keys"), p = e("has-binary"), d = e("arraybuffer.slice"), f = e("base64-arraybuffer"), l = e("after"), h = e("utf8"), g = navigator.userAgent.match(/Android/i), m = /PhantomJS/i.test(navigator.userAgent), v = g || m;
            n.protocol = 3;
            var y = n.packets = {
                open: 0,
                close: 1,
                ...
                upgrade: 5,
                noop: 6
            }, b = u(y), w = {type: "error", data: "parser error"}, S = e("blob");
            n.encodePacket = function (e, t, n, i) {
                ...
                if ("string" == typeof e || void 0 === e) {
                    ...
                    var i = e.charAt(0);
                    return Number(i) == i && b[i] ? e.length > 1 ? {type: b[i], data: e.substring(1)} : {type: b[i]} : w
                }
                var a = new Uint8Array(e), i = a[0], s = d(e, 1);
                return S && "blob" === t && (s = new S([s])), {type: b[i], data: s}
            }, n.decodeBase64Packet = function (e, t) {
                var n = b[e.charAt(0)];
                if (!c.ArrayBuffer)return {type: n, data: {base64: !0, data: e.substr(1)}};
                var r = f.decode(e.substr(1));
                return "blob" === t && S && (r = new S([r])), {type: n, data: r}
        ...
        78: [function (e, t) {
            var n = e("has-cors");
            t.exports = function (e) {
                var t = e.xdomain, r = e.xscheme, o = e.enablesXDR;
                try {
        ...
        96: [function (e, t) {
            ...
            var a = 1e3, s = 60 * a, c = 60 * s, u = 24 * c, p = 365.25 * u;
            t.exports = function (e, t) {
        ...
        80: [function (e, t) {
            ...
            var o = self, i = e("./polling"), a = e("component-inherit");
            t.exports = r;
            var s, c = /\n/g, u = /\\n/g;
            a(r, i), r.prototype.supportsBinary = !1, r.prototype.doClose = function () {
                ...
                var o = this;
                if (!this.form) {
                    var i, a = document.createElement("form"), s = document.createElement("textarea"), p = this.iframeId = "eio_iframe_" + this.index;
        ...
        }, {"./polling": 97, "component-inherit": 98}],
        81: [function (e, t) {
            function n(e) {
            ...
            var r = e("../transport"), o = e("engine.io-parser"), i = e("parseqs"), a = e("component-inherit"), s = e("debug")("engine.io-client:websocket"), c = e("ws");
        ...
        }, {"../transport": 85, "component-inherit": 98, debug: 86, "engine.io-parser": 72, parseqs: 84, ws: 99}],
        99: [function (e, t) {
            function n(e, t) {
                var n;
        ...
        79: [function (e, t) {
            ...
            var a = self, s = e("xmlhttprequest"), c = e("./polling"), u = e("component-emitter"), p = e("component-inherit"), d = e("debug")("engine.io-client:polling-xhr");
        ...
        }, {"./polling": 97, "component-emitter": 49, "component-inherit": 98, debug: 86, xmlhttprequest: 78}],
        95: [function (e, t) {
            var n = e("global");
            try {
        ...
        97: [function (e, t) {
            ...
            var r = e("../transport"), o = e("parseqs"), i = e("engine.io-parser"), a = e("component-inherit"), s = e("debug")("engine.io-client:polling");
            t.exports = n;
            var c = function () {
